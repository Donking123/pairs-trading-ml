...
CRSP_PATH   = DATA_DIR / "crsp_close.parquet"
FACTOR_PATH = DATA_DIR / "factor_close.parquet"
...
def _load_features(
    ...
    """Build 2-feature DataFrame from SPY and CRSP constituent prices.

    log_rvol: SPY 20-day rolling realized vol (annualized)
    log_disp: 20-day rolling mean of cross-sectional daily return std
    """
